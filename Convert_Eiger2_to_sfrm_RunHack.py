...
def parallel_read(set, idx, inum, ih5, _ARGS, overwrite=False):
    # guess a name
    _ARGS._CHI, _ARGS._TTH, _ARGS._RUN = _ARGS._RUNLIST[ih5]
...
if __name__ == '__main__':
    ...
    # sloppy hack to work with master.h5 files that contain more than one run!
    # [(chi angle, 2-theta, run number), (...), ...]
    _ARGS._RUNLIST = [( 0.000,   0.000,  1), ( 0.000,   0.000,  1),
                      (15.000,   0.000,  2), (15.000,   0.000,  2),
                      (25.000,   0.000,  3), (25.000,   0.000,  3),
                      (35.000,   0.000,  4), (35.000,   0.000,  4),
                      (45.000,   0.000,  5), (45.000,   0.000,  5),
                      ( 0.000, -10.000,  6), ( 0.000, -10.000,  6),
                      (15.000, -10.000,  7), (15.000, -10.000,  7),
                      (25.000, -10.000,  8), (25.000, -10.000,  8),
                      (35.000, -10.000,  9), (35.000, -10.000,  9),
                      (45.000, -10.000, 10), (45.000, -10.000, 10),
                      ( 0.000, -20.000, 11), ( 0.000, -20.000, 11),
                      (15.000, -20.000, 12), (15.000, -20.000, 12),
                      (25.000, -20.000, 13), (25.000, -20.000, 13),
                      (35.000, -20.000, 14), (35.000, -20.000, 14),
                      (45.000, -20.000, 15), (45.000, -20.000, 15),
                      ( 0.000, -30.000, 16), ( 0.000, -30.000, 16),
                      (15.000, -30.000, 17), (15.000, -30.000, 17),
                      (25.000, -30.000, 18), (25.000, -30.000, 18),
                      (35.000, -30.000, 19), (35.000, -30.000, 19),
                      (45.000, -30.000, 20), (45.000, -30.000, 20)]
    ...
    with mp.Pool() as pool:
        ...
        for ih5, entry in enumerate(h5files):
            ...
            while idx + _ARGS._SUM <= h5inum[ih5]:
                ...
                pool.apply_async(parallel_read, args=[entry,idx,inum,ih5,_ARGS], callback=converted.append)
                # increment start
                idx += _ARGS._SUM
